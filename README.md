...
### 3.6 Test case results
Test cases are executed on the created test Cycle summary and the results can be seen here: [Test case results]([https://github.com/opreabogdan1/Proiect-practic-TM/blob/main/Traceability_Matrix.xlsx](https://github.com/opreabogdan1/Proiect-practic-TM/blob/main/Test%20case%20execution.pdf))
